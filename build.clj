...
(def lib 'com.github.brettatoms/ring-hot-reload)
...
(defn- pom-template [version]
  [[:description "Hot reload middleware for Ring"]
   [:url "https://github.com/brettatoms/ring-hot-reload"]
   [:licenses
    [:license
     [:name "MIT License"]
   ...
   [:scm
    [:url "https://github.com/brettatoms/ring-hot-reload"]
    [:connection "scm:git:https://github.com/brettatoms/ring-hot-reload.git"]
    [:developerConnection "scm:git:ssh:git@github.com:brettatoms/ring-hot-reload.git"]
    [:tag (str "v" version)]]])
